...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#232323]">
      <div className={` grid grid-cols-5 px-4 md:px-10 lg:px-0 gap-2`}>
        {/* ---- Logo ---- */}
        <Link
        ...
        <div className="col-span-3 w-full">
          {/* ---- Number ---- */}
          <div
            className={`flex gap-[10px] md:gap-8 items-center justify-end py-2 xl:pr-20 lg:pr-10 ${Style.navContact}`}
          >
            <div className="flex gap-4 items-center">
              <div className="w-10 h-10 rounded-full flex justify-center items-center bg-white bg-opacity-10">
                <svg
              ...
              <p className="hidden lg:block">+91 99099 83100</p>
            </div>
          ...
          {/* ---- Menu ---- */}
          <div
            className={`hidden lg:flex items-center py-2   justify-between 2xl:gap-28 xl:px-20 xl:pl-12 xl:gap-8 lg:px-10 lg:gap-4 lg:pl-5 ${Style.navMenu}`}
          >
            ...
            <button
              className={`flex gap-2 text-white px-4 lg:px-0 py-2 items-center w-52 lg:w-44 justify-center ${Style.btn}`}
            >
