...
const Footer = () => {
  return (
    <footer
      className={`${(Style.footer, Style.footer_container)} pt-6 lg:pt-16`}
    >
      <div className="footer_up px-4 max-w-7xl mx-auto mb-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-between md:py-10, gap-10 ">
        <div className="col-span-1 md:col-span-2 lg:col-span-1  w-full footer_up_1 flex flex-col gap-4 items-center ">
          ...
          <div className=' w-full'>
            <div className="flex justify-between gap-2 mt-2 mx-auto lg:mx-0 xl:hidden w-3/4 md:w-1/3 lg:w-3/4 max-w-sm">
        ...
        <div className="col-span-1 w-full footer_up_4 xl:flex flex-col md:gap-6 hidden">
          ...
          <div className="flex justify-between gap-3 mx-auto lg:mx-0  max-w-[230px]">
            <div className="w-9 h-9 rounded-full flex justify-center items-center bg-white bg-opacity-10">
              <svg
                width="18"
                height="18"
      ...
      <div className="footer_down max-w-7xl mx-auto py-4 px-4">
